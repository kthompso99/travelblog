...
import { discoverAllTrips, loadJsonFile, writeJsonFile } from './build-utilities.js';
...
/**
 * Directories to skip when scanning for content changes
 */
const IGNORED_DIRS = new Set(['audits']);
...
function getCoreFiles() {
    const files = [
        ...
        path.join(CONFIG.LIB_DIR, 'generate-homepage.js'),
        path.join(CONFIG.LIB_DIR, 'generate-trip-pages.js'),
        path.join(CONFIG.LIB_DIR, 'generate-global-pages.js'),
        path.join(CONFIG.LIB_DIR, 'generate-html-helpers.js'),
