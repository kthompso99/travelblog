...
export default {
    ...
    /**
     * Helper: Get path to trip overview.md file
     * @param {string} tripId - Trip ID
     * @returns {string} Path to overview.md
     */
    getTripOverviewPath(tripId) {
        return `${this.TRIPS_DIR}/${tripId}/${this.TRIP_OVERVIEW_FILE}`;
    },
    ...
    getTripImagesDir(tripId) {
        return `${this.TRIPS_DIR}/${tripId}/${this.TRIP_IMAGES_SUBDIR}`;
    },
