...
import { getGoogleMapsApiKey } from './maps-config.js';
import { ensureDir, loadJsonFile, writeJsonFile } from './build-utilities.js';
...
function saveGeocodeCache() {
    ...
    writeJsonFile(CONFIG.GEOCODE_CACHE_FILE, cache);
}
...
/**
 * Check if a location is already in the geocode cache (no API call needed).
 */
function isCachedGeocode(locationName) {
    return !!cache[locationName];
}

export { loadGeocodeCache, geocodeLocation, isCachedGeocode };
