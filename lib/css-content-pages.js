...
const CSS_CONTENT_PAGES = `
        ...
        .nutshell-section {
            ...
            animation: nutshellFadeIn 0.6s ease-out;
        }
        ...
        /* Meta row: subtitle left, badges right */
        .nutshell-meta {
            display: flex;
            align-items: center;
        ...
        /* Verdict badge — default gradient, overridden per level */
        .nutshell-verdict {
        ...
        .nutshell-verdict:hover {
            transform: scale(1.05);
        }

        .nutshell-verdict--would-plan-around {
            background: linear-gradient(135deg, #d97706, #ea580c);
        }

        .nutshell-verdict--glad-we-went {
            background: linear-gradient(135deg, #f59e0b, #f97316);
        }

        .nutshell-verdict--lovely-but-optional {
        ...
        .nutshell-duration svg {
            width: 12px;
            height: 12px;
        }

        /* Fields grid — 2-column base for pair fields */
        .nutshell-fields {
            display: grid;
        ...
        .nutshell-field:hover {
            transform: translateX(4px);
        }

        .nutshell-field:last-child {
            border-bottom: none;
        }

        /* 2-column pair fields (Stay Overnight, Return Visit) */
        .nutshell-field--pair {
            grid-column: span 1;
        }

        /* Highlighted field (Don't Miss) — negative margins cancel the
           left/right padding so the icon stays aligned with other fields */
        .nutshell-field--highlight {
            background: rgba(251, 191, 36, 0.15);
            padding: 0.75rem;
        ...
        /* Return Visit yes/no indicators */
        .nutshell-return-yes {
            color: #15803d;
            font-weight: 600;
        }

        .nutshell-return-yes .nutshell-indicator {
            width: 16px;
            height: 16px;
            color: #16a34a;
            vertical-align: -2px;
        ...
        .nutshell-return-no .nutshell-indicator {
            width: 16px;
            height: 16px;
            color: #9ca3af;
            vertical-align: -2px;
        ...
        /* Soften Remark42 auth/sign-in buttons */
        #remark42 .auth-panel .auth-button,
        #remark42 .auth-panel button {
            opacity: 0.7;
            transition: opacity 0.2s;
        }

        #remark42 .auth-panel .auth-button:hover,
        #remark42 .auth-panel button:hover {
            opacity: 1;
        }
        ...
        .trip-map-sidebar::after {
            ...
            right: 0;
            height: 48px;
            background: linear-gradient(to bottom, transparent, #fdf8ef);
            pointer-events: none;
            display: block;
        ...
        /* Unread: empty circle with warm border */
        .toc-indicator--unread {
        ...
        .toc-indicator--read svg {
            width: 12px;
            height: 12px;
        }

        /* Current: filled amber */
        .toc-indicator--current {
            background: linear-gradient(135deg, #f59e0b, #d97706);
            border: none;
        }

        /* Active dot on right side */
        .toc-active-dot {
            width: 7px;
            height: 7px;
            border-radius: 50%;
        ...
        .toc-item.active .toc-active-dot {
            opacity: 1;
        }
