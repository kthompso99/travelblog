...
function generateTripFiles(tripData, output, domain, indent = '') {
    ...
    locations.forEach((location) => {
        ...
        const locationHtml = generateTripLocationPage(tripMetadata, location, allContent, contentIndex, output, domain);
    ...
    articles.forEach((article) => {
        ...
        const articleHtml = generateTripArticlePage(tripMetadata, article, allContent, contentIndex, output, domain);
