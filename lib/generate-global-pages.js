...
import { escapeHtml } from './seo-metadata.js';
...
function generateMapPage(config, domain) {
    ...
    const mapScript = fillTemplate(readTemplate('map-global-script.html'), {
        GOOGLE_MAPS_API_KEY: getGoogleMapsApiKey(),
        MAP_CONFIG_JSON: JSON.stringify(mapConfig, null, 2),
        MAP_STYLES: getMapStylesJson()
    });
...
export { generateMapPage, generateAboutPage };
