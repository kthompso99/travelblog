...
function buildMapLink(currentPage, basePath) {
    ...
    return `
                <li><a href="${basePath}map.html"${active}>Map</a></li>`;
}
...
function buildPhotoGallery(gallery, locationTitle = 'Photo Gallery', basePath = './') {
    ...
    // Camera icon SVG
    const cameraIcon = `<svg class="gallery-icon" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path>
        <circle cx="12" cy="13" r="4"></circle>
    </svg>`;

    // Zoom icon SVG for gallery items
