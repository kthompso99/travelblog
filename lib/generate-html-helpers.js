...
import { assembleTemplate } from './template-utilities.js';
import { getPageCSS } from './css-utilities.js';
import { getRemark42Config } from './remark42-config.js';
import { readTextFile } from './build-utilities.js';
 ...
 */
function renderPage(config, { basePath, seoMetadata, content, cssKey, tripSubmenu, preMain, scripts }) {
...
export { readTemplate, buildTripsMenu, formatMonthYear, renderPage };
