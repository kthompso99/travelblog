...
A path winds down from the old town to several viewpoints along the gorge, and it's not obvious where to stop.  Partway down the gorge is a paid attraction called [Tagus Gorge](https://desfiladerodeltajo.info/).  We paid about €5 for access -- a bargain. There are viewpoints lower in the gorge, but the heat made this one feel like enough.
...
We saw Paco Seco perform at [Ronda Guitar Music](https://www.rondaguitarmusic.com/) the evening we were there. The venue is a small street-front room -- maybe 20 seats -- with handcrafted guitars lining the walls. Paco Seco and his wife Lucy greeted us at the door, immediately calling out "Kevin & Tiffany!" as we were the last to arrive.

Paco played 4 or 5 different guitars over the course of the evening, and the differences weren't subtle. 
...
The whole thing lasted about an hour. No stage, no amplification, close enough to see the calluses on his fingers. It's the kind of intimate experience that only works at that scale.
...
![Plaza de Toros](images/ronda-03.jpg)

## Where We Stayed

We stayed at [Hotel Montelirio](https://www.hotelmontelirio.com/en/).  It's a lovely hotel, but the real reason to book it is the gorge view. Book a room facing the bridge; the difference between that and a standard room is the difference between a good stay and a memorable one.
...
One thing we wish we'd planned for: [Cueva Pileta](https://wagonersabroad.com/ronda-spain-cave/) a cave outside town with paintings tens of thousands of years old. We missed it in planning. By all accounts, it's exceptional, especially for those (ahem) obsessed with ancient sites.
